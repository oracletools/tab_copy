...
class TestPanel(wx.Panel):
	...
	def __init__(self, parent):
		...
		pprint (dir(self.ultimateList))
		item=self.ultimateList.GetItem(0, 0)
		#item.SetHyperText(True)
		#self.ultimateList.SetItem(item)
		self.ultimateList.SetItemHyperText(item,True)
		sizer = wx.BoxSizer(wx.VERTICAL)
		
		item=self.ultimateList.GetItem(0, 1)
		#item.SetHyperText(True)
		#self.ultimateList.SetItem(item)
		self.ultimateList.SetItemHyperText(item,False)
		self.ultimateList.SetItemText(0,'test')
		self.ultimateList.SetItem(item)
