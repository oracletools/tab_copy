...
try:
	...
	class CodeEditor(XmlSTC):
		def __init__(self, parent, ID,style=wx.BORDER_NONE):
			XmlSTC.__init__(self, parent, ID, style=style)
		...
		print 'cannot init class CodeEditor(XmlSTC)'
		sys.exit(1)
...
class SimpleXMLEditor(wx.MiniFrame):
	def __init__(self, parent, log, title, file_to_open):
		...
		self.panel = SimpleXMLPanel(self, log, file_to_open)
		#self._mgr = AUIManager(self)
		self.finddata = wx.FindReplaceData()
		self.finddata.SetFlags(wx.FR_DOWN)
		#self.firstTime = True
