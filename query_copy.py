...
class QCD_Configuration(wx.Panel):
	...
	def __init__(self, parent, frame,style,data):
		...
		self.tree = MyGizmos(self.splitter, -1, style =
										wx.TR_DEFAULT_STYLE
										#| wx.TR_HAS_BUTTONS
										#| wx.TR_TWIST_BUTTONS
										#| wx.TR_ROW_LINES
		...
		if 1:
			...
			child = self.tree.AppendItem(self.tree.root, txt)
			...
			self.tree.SetItemData(self.tree.root,wx.TreeItemData((0,0,'root')))
			self.tree.SetItemData(child,wx.TreeItemData((0,1,'item')))
		...
		sizer.Add(self.splitter, 1, wx.GROW|wx.EXPAND|wx.ALL, 1)
...
class QueryCopyDialog(wx.Dialog):
	def __init__(
		...
		# contents
		sizer = wx.BoxSizer(wx.VERTICAL)
		self.config_panel=QCD_Configuration(self,parent,style=wx.TAB_TRAVERSAL|wx.CLIP_CHILDREN, data=self.data)
