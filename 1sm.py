...
class DataBuddy(wx.Frame):
	def __init__(self, parent, id, title):
		...
		super(DataBuddy, self).__init__(parent, title=title , size=(550, 340))
		global prog
		...
		if 1:
			...
			boxsizer.Add(rb, flag=wx.LEFT|wx.TOP, border=5)
			rb.Enable(False)			
			sizer.Add(boxsizer, pos=(2, 0), span=(1, 5), flag=wx.EXPAND|wx.TOP|wx.LEFT|wx.RIGHT , border=5)		
